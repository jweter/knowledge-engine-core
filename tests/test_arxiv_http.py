...
from knowledge_engine.arxiv_http import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://example.com/api/query?search_query=test",
        "https://user:pass@export.arxiv.org/api/query?search_query=test",
        "https://export.arxiv.org:444/api/query?search_query=test",
    ],
)
def test_transport_rejects_unsafe_or_unsupported_urls(url: str) -> None:
    transport = UrllibArxivTransport()
