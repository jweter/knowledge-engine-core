...
from knowledge_engine.semantic_scholar_http import (
    ResponseTooLargeError,
    UrllibSemanticScholarTransport,
    _read_bounded,
)
...
@pytest.mark.parametrize(
    "url",
    [
        "http://api.semanticscholar.org/graph/v1/paper/search?query=test",
        "https://example.com/graph/v1/paper/search?query=test",
        "https://user:pass@api.semanticscholar.org/graph/v1/paper/search?query=test",
        "https://api.semanticscholar.org:444/graph/v1/paper/search?query=test",
    ],
)
def test_transport_rejects_unsafe_or_unsupported_urls(url: str) -> None:
    transport = UrllibSemanticScholarTransport()
