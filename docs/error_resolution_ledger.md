...
- **Affected files:** `knowledge_engine/candidate_review.py`, `tests/test_candidate_review.py`, `docs/m14_candidate_review_worksheet.md`, `docs/m14_pmc_oa_acquisition.md`
