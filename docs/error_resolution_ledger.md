...
- **Status:** open (mitigated) — the retry/backoff and diagnosability gap is fixed and unit-tested; the exact original cause of this specific failure remains unconfirmed, and a full-scale live run has not yet re-exercised the fix.
