...
_REPOSITORY = "jweter/knowledge-engine-core"
_ISSUE_NUMBER = 493
...
def _body(payload: dict[str, object]) -> str:
    ...
    return "\n".join(
        [
            "## Unattended Core verification — sanitized exact-head result",
            "",
...
def publish_sanitized_result(
    ...
    *,
    ...
    """Best-effort remote observability for the local Core verification worker.
    ...
    _write_state(state_path, "PUBLISHED", key, "Sanitized result posted to issue #493")
    return "PUBLISHED"
