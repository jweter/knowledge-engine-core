...
This repository is the Core layer of the Knowledge Engine system.
...
1. `AGENTS.md` — repository agent entry point and current mandatory product-direction documents.
